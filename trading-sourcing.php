...
<head>
    ...
    <meta name="description" content="corpx - Business Consulting HTML Template">
    <!-- ======== Page title ============ -->
    <title>AVCONEXPO | Trading & sourcing</title>
    <!--<< Favcion >>-->
        ...
        <div class="container">
            <div class="page-heading">
                <div class="breadcrumb-sub-title">
                    <h1 class="wow fadeInUp" data-wow-delay=".3s">Trading & sourcing</h1>
                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="project-info-list">
                                ...
                                <ul class="wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <li>
                                        <span> Share:</span> <span class="social-links">
