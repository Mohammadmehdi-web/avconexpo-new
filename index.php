...
<body>
                        ...
                        <div class="about-content">
                            ...
                            <ul class="list-title wow fadeInUp" data-wow-delay=".3s">
                                <div class="row d-flex">
                                    ...
                                    <div class="col-lg-6">
                                        <li style="font-size:15px">
                                            <div style="display: flex;gap: 5px; " class="res-mt-3">
                                                <img class="mt-2" width="20" height="20"
                                                    src="https://img.icons8.com/windows/50/approval.png"
                                                    alt="approval" />
                            ...
                            <a class="theme-btn wow fadeInUp" data-wow-delay=".5s" href="about.php">
        ...
        <div class="service-container-wrapper style1">
            ...
            <div class="container">
                <div class="section-title text-center mx-auto">
                    ...
                    From concept to consumer, end-to-end industrial solutions by our experts for sustainable growth
                    </h2>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                data-wow-delay="0.2s">
                                <div class="thumb"><img src="assets/img/service/servicecardThumb_1.jpg" alt="thumb"> </div>
                                <div class="content">
                                    <h4><a href="business-technical-consulting.php">Business & Technical Consultancy</a></h4>
                                    <p class="text"> From Idea to Execution – We plan, design, build, and deliver turnkey projects with technical, commercial, and strategic excellence.</p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                                    <a href="business-technical-consulting.php">Read more</a>
                                    <a href="business-technical-consulting.php"><i
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                ...
                                <div class="content">
                                    ...
                                    <p class="text"> From Planning to Handover — We manage timelines, teams, and targets, ensuring seamless project delivery with precision, quality, and accountability.</p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                                    <a href="project-management.php">Read more</a>
                                    <a href="project-management.php"><i
                                            class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                ...
                                <div class="content">
                                    ...
                                    <p class="text"> From Procurement to Logistics — We source and supply industrial equipment and materials globally, ensuring quality, compliance, and cost-efficiency.</p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                ...
                                <div class="content">
                                    ...
                                    <p class="text">From Blueprint to Brilliance – We create functional, aesthetic, and sustainable designs tailored to modern industrial and commercial needs.</p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                                    <a href="architecture-design.php">Read more</a>
                                    <a href="architecture-design.php"><i
                                            class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                data-wow-delay="0.2s">
                                <div class="thumb"><img src="assets/img/service/StartupAcc.png" alt="thumb"> </div>
                                <div class="content">
                                    <h4><a href="startup-accelerator.php">Startup Accelerator</a></h4>
                                    <p class="text"> From Vision to Venture— we empower startups with strategy, structure, tech expertise, funding support, and market access for rapid, sustainable growth.</p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                                    <a href="startup-accelerator.php">Read more</a>
                                    <a href="startup-accelerator.php"><i
                                            class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                data-wow-delay="0.2s">
                                <div class="thumb"><img src="assets/img/service/reviving image.avif" alt="thumb"> </div>
                                <div class="content">
                                    <h4><a href="reviving-sick-industries.php">Reviving Sick Industries</a></h4>
                                    <p class="text">From Inefficiency to Impact– We restructure struggling industries with diagnostic Audits & Insights, Operational Reforms, and Profitable turnaround strategies.</p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                                    <a href="reviving-sick-industries.php">Read more</a>
                                    <a href="reviving-sick-industries.php"><i
                                            class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                ...
                                <div class="content">
                                    ...
                                    <p class="text"> From Waste to Wealth— We offer sustainable waste solutions that optimize resources, reduce impact, and support circular economy goals.
                                    </p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                                    <a href="waste-management.php">Read more</a>
                                    <a href="waste-management.php"><i
                                            class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                ...
                                <div class="content">
                                    ...
                                    <p class="text"> We have all the alliances and networks with leading international and domestic experts in architectural domains to put the projects together.</p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                                    <a href="agriculture-ecotourism.php">Read more</a>
                                    <a href="agriculture-ecotourism.php"><i
                                            class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="service-card style1 wow fadeInUp" data-tilt data-tilt-max="15"
                                ...
                                <div class="content">
                                    ...
                                    <p class="text">From People to Performance — We align talent with strategy, empowering organizations through smart hiring, capability building, and leadership development.
                                    </p>
                                    <div class="icon"> <i class="icon-serviceIcon1_1"></i> </div>
                                </div>
                                <div class="link-meta">
                                    <a href="talent-management.php">Read more</a>
                                    <a href="talent-management.php"><i
                                            class="fa-sharp fa-regular fa-arrow-up-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-11">
                            <div class="about-service-meta">
                                ...
                                <div class="meta-box wow fadeInUp" data-wow-delay=".8s">
                                    <div class="counter">
                                        <img width="50" height="50"
                                            src="https://img.icons8.com/ios/50/FFFFFF/smiling-face-with-heart.png" />
                                        <span class="counter-number"> 100 </span>%
                                    </div>
                                    <p class="text text-capitalize">Customer satisfaction</p>
    ...
    <div class="blog-section section-padding fix pb-0">
                      ...
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                          <div class="">
                            <div class="blog-card style1 wow fadeInUp" data-wow-delay="0.3s">
                              <div class="thumb img-shine">
                                 <img src="assets/img/service/edible oil sector.png" alt="thumb" />
                              </div>
                              <div class="content mt-3">
                                    <h4>
                                         Edible Oil Industry
                        ...
                        <div class="swiper-slide">
                          <div class="">
                            <div class="blog-card style1 wow fadeInUp" data-wow-delay="0.3s">
                              <div class="thumb img-shine">
                                 <img src="assets/img/service/utilities.jpg" alt="thumb" />
                              </div>
                              <div class="content mt-3">
                                    <h4>
                    ...
                    <div class="row d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-xl-6 d-flex justify-content-lg-end">
                            <div class="btn-wrapper wow fadeInUp" data-wow-delay="0.3s">
                                <a class="theme-btn" href="blogs.php">
